...
export const translations = {
  en: {
    ...
    "next.progress": "{completed} / {target} done today",
    "next.inMinutes": "in {min} min",
    "next.dueNow": "Due now",
    ...
    "settings.firstTime": "First time (HH:mm)",
    "settings.lastTime": "Last time (HH:mm)",
    "settings.duration": "Session duration (minutes)",
  ...
  pt: {
    ...
    "next.progress": "{completed} / {target} feitos hoje",
    "next.inMinutes": "em {min} min",
    "next.dueNow": "Agora",
    ...
    "settings.firstTime": "Primeiro horário (HH:mm)",
    "settings.lastTime": "Último horário (HH:mm)",
    "settings.duration": "Duração da sessão (minutos)",
  ...
  es: {
    ...
    "next.progress": "{completed} / {target} hechos hoy",
    "next.inMinutes": "en {min} min",
    "next.dueNow": "Ahora",
    ...
    "settings.firstTime": "Primera hora (HH:mm)",
    "settings.lastTime": "Última hora (HH:mm)",
    "settings.duration": "Duración de la sesión (minutos)",
  ...
  fr: {
    ...
    "next.progress": "{completed} / {target} faits aujourd'hui",
    "next.inMinutes": "dans {min} min",
    ...
    "settings.firstTime": "Première heure (HH:mm)",
    "settings.lastTime": "Dernière heure (HH:mm)",
    "settings.duration": "Durée de la séance (minutes)",
  ...
  it: {
    ...
    "next.progress": "{completed} / {target} fatti oggi",
    "next.inMinutes": "tra {min} min",
    "next.dueNow": "Adesso",
    ...
    "settings.firstTime": "Primo orario (HH:mm)",
    "settings.lastTime": "Ultimo orario (HH:mm)",
    "settings.duration": "Durata della sessione (minuti)",
